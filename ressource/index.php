            ...
            <div class="table-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i
                                    class="material-icons">&#xE147;</i> <span>Add ressource</span></a>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        $sqlSelect = "SELECT ressource_id , name_categorie, name_sub_categorie, name_ressource FROM ressources join categorie,subcategory where ressources.categorie_id=categorie.categorie_id and ressources.sub_categorie_id=subcategory.sub_categorie_id";
                        ...
                        foreach ($result as $data) {
                            ...
                            <tr>
                                <td>
                                    <?php echo $data['ressource_id']; ?>
                                </td>
                                <td>
                                    <?php echo $data['name_ressource']; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="view.php?id=<?php echo $data['ressource_id']; ?>" class="btn btn-info">Read
                                        More</a>
                                    <a class="btn btn-warning"
                                        href="edit.php?id=<?php echo $data['ressource_id']; ?>">Edit</a>
                                    <a href="delete.php?id=<?php echo $data['ressource_id']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="name_sub_categorie" required>
                                ...
                                while ($row = $subcategoryResult->fetch_assoc()) {
                                    // Récupérer la valeur postée s'il y en a une
                                    $selected = (isset($_POST['name_sub_categorie']) && $_POST['name_sub_categorie'] == $row['name_sub_categorie']) ? 'selected' : '';
